export const CLEAN_EMAIL_PROMPT = `
    ...
    ### **Example Input 5:**
        This order was placed and paid for on October 2, 2024.  We have inquired the status many times.  On 11/9/24 you provided tracking number 9400111206239187734376, When I track that number it has not left your facility.  Will you provide a date this will be shipped and if not, we would like to request a refund. Look look forward to your reply.

        On Sat, Nov 9, 2024 at 3:59 AM Hodgetwins Support < 
        info@officialhodgetwins.com
        > wrote:

        Hi, Randall!

        Thanks for getting back Your order was assigned with the tracking number *9400111206239187734376 *on October 23 and not sure what the hols up in your order. Therefore, I contacted our fulfillment team to check and ship your order immediately.

        Thanks for your support and understanding. If you have any questions, please get in touch with us immediately.

        Thank You
        Shop Crowder Customer Support 
